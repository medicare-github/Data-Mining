                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Edit Nilai Ujian Nasional <i style="color: orange; font-style: normal;">SMK</i></a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <form action="../proses/MajorEditPro.php" method="post">
                                            <?php
                                            include '../connection/connection.php';
                                            $id = $_GET['kode'];
                                            $query = "SELECT * FROM major_highsc WHERE id='$id'";
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="review-content-section">
                                                            ...
                                                            <div class="input-group mg-b-pro-edt">
                                                                <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                                <input type="text" class="form-control" name="kjr" placeholder="Fisika" value="<?= $data->kejuruan ?>">
                                                            </div>
