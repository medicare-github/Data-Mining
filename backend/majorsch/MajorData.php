                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
                                            ...
                                            <div class="breadcomb-ctn">
                                                <h2>List Data Set <span style="color: orange;">SMK</span></h2>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h4 style="color: orange;">SMK DATA</h4>
                            <div class="add-product">
                                <a href="MajorInput.php">Add data</a>
                            </div>
                            <table>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    while ($data = mysqli_fetch_object($result)) :
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $data->jurusan ?></td>
                                            <td>
                                                <a href="MajorEdit.php?kode=<?= $data->id ?>" style="color: white;">
                                                ...
                                                <a href="MajorDelete.php?kode=<?= $data->id ?>" onclick="return confirm('Yakin untuk menghapus?')" style="color: white;">
